...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/livekit-protocol-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/livekit-protocol-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add livekit-protocol
# for installing globally
pixi global install livekit-protocol
```
...
It is possible to list all of the versions of `livekit-protocol` available on your platform:
...
```
pixi search livekit-protocol --channel conda-forge
```
